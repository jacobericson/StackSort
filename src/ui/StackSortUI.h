...
class StackSortUI
{
  ...
  private:
    ...
    static void OnSortRightClick(MyGUI::Widget* sender, int left, int top, MyGUI::MouseButton id);
    ...
    static void ApplySort(InventoryGUI* gui, int target, int& outAppliedLerSide, int& outSourceTarget);
